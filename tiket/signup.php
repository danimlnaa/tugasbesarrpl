...
<body style="background: url(image/bg-5.jpg); background-size: contain;" class="trans">
        ...
        <center>
            <div style="padding-top: 125px;">
                <a href="index.php" onclick="window.close();">
                    <img src="image/prima.png" class="img-responsive" style="width: 100px; height: 100px;">
                </a>
